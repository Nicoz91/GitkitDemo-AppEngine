 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "google.com", ownerName = "google.com", packagePath="identitytoolkit.demo"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAnpJZZ-QZlsBzpEGVYDj3rtHjAOFnkEPg";
